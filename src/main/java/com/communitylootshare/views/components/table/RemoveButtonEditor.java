...
public class RemoveButtonEditor extends DefaultCellEditor
{
	private static final FlatSVGIcon REMOVE_ICON = new FlatSVGIcon(
		RemoveButtonEditor.class.getResource("/com/communitylootshare/icons/sleep.svg")).derive(16, 16);
	private static final FlatSVGIcon ADD_ICON = new FlatSVGIcon(
		RemoveButtonEditor.class.getResource("/com/communitylootshare/icons/sunrise.svg")).derive(16, 16);
