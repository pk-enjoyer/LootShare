...
final class HistoryEditorPanel extends JPanel
{
	...
	private static final Border LOCKED_BORDER = BorderFactory.createCompoundBorder(
		...
		BorderFactory.createEmptyBorder(3, 3, 3, 3));
	private static final ImageIcon DELETE_ICON = loadRasterIcon("/com/communitylootshare/icons/trash-solid-full.png", 16);
	private static final FlatSVGIcon DRAG_HANDLE_ICON = loadSvgIcon("/com/communitylootshare/icons/drag-handle.svg");
	private static final FlatSVGIcon UNDO_ICON = loadSvgIcon("/com/communitylootshare/icons/undo.svg");
	private static final FlatSVGIcon REDO_ICON = loadSvgIcon("/com/communitylootshare/icons/redo.svg");
