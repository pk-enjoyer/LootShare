...
public class LootshareState
{
	...
	public LootshareSession getActiveSession()
	{
		return activeSession;
	}

	public void setActiveSession(LootshareSession value)
	{
		activeSession = value;
	}
	...
	{
		return proposals == null ? new ArrayList<>() : proposals;
	}

	public void setProposals(List<LootProposal> value)
	{
		proposals = value == null ? new ArrayList<>() : value;
	}
}
