...
public final class Metrics extends AbstractTableModel
{
	private static final FlatSVGIcon REMOVE_ICON = new FlatSVGIcon(
		Metrics.class.getResource("/com/communitylootshare/icons/sleep.svg")).derive(16, 16);
	private static final FlatSVGIcon ADD_ICON = new FlatSVGIcon(
		Metrics.class.getResource("/com/communitylootshare/icons/sunrise.svg")).derive(16, 16);

	private final JButton removeBtn = createStyledButton("/com/communitylootshare/icons/sleep.svg");
	private final JButton addBtn = createStyledButton("/com/communitylootshare/icons/sunrise.svg");
