...
public class HostMessage extends PartyMemberMessage
{
	...
	{
		if (hostMemberId <= 0L || minimumSharedLootValue < 0L || revision <= 0L) throw new IllegalArgumentException("Valid host state is required");
		this.hostMemberId = hostMemberId; this.minimumSharedLootValue = minimumSharedLootValue; this.revision = revision;
	}
	...
	public static final class DecodedHostState { private final long hostMemberId, minimumSharedLootValue, revision; private DecodedHostState(long h, long m, long r) { hostMemberId=h; minimumSharedLootValue=m; revision=r; } public long getHostMemberId(){return hostMemberId;} public long getMinimumSharedLootValue(){return minimumSharedLootValue;} public long getRevision(){return revision;} }
}
