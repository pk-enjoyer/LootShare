...
public class TableModelsTest
{
	...
	public void testPanelViewRefreshMetricsUsesEditableHistorySession() throws Exception
	{
		...
		SwingUtilities.invokeAndWait(() -> viewRef.set(new PanelView(sessionManager, config, playerManager, mock(com.communitylootshare.controllers.PanelController.class))));
